...
```
Agent(
  prompt="Read C:/Users/Sai Teja Ankam/Desktop/TCS JL/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Sai Teja Ankam/Desktop/TCS JL/.claude/gsd-core/templates/SECURITY.md`
