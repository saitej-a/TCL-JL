...
**`/gsd-capture --note <text>`** — Zero-friction timestamped note to `.planning/notes/` (or `C:/Users/Sai Teja Ankam/Desktop/TCS JL/.claude/notes/` globally). Subcommands: append (default), list, promote (note → todo). Works without a project.
