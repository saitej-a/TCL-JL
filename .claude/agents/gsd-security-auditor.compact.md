...
**Verification depth scales with `asvs_level`** (full definitions: @C:/Users/Sai Teja Ankam/Desktop/TCS JL/.claude/gsd-core/references/security-asvs-levels.md):
