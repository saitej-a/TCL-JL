...
**Verification depth scales with `asvs_level`** (see @C:/Users/Sai Teja Ankam/Desktop/TCS JL/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
